...
\input{tex/1_Zalozenia_projektowe.tex}
\input{tex/2_Opis_uzytych_technologii.tex}
\input{tex/3_Schemat_logiczny.tex}
\input{tex/4_Instalacja_uslug.tex}
\input{tex/5_Testy.tex}
\input{tex/6_Wnioski.tex}

\input{tex/7_bibliografia.tex}
